...
const FAQS = [
  {
    q: "سن یار چگونه کار می‌کند؟",
    a: "ردیاب کوچک سن یار همراه عزیزتان قرار می‌گیرد و موقعیت، حرکت و وضعیت او را به‌صورت لحظه‌ای از طریق شبکه موبایل به اپلیکیشن خانواده می‌فرستد. ایستگاه درب هوشمند نیز کنار در نصب می‌شود تا خروج بدون ردیاب را تشخیص دهد.",
  },
  {
    q: "شارژ باتری چند روز دوام می‌آورد؟",
    a: "با یک بار شارژ کامل، ردیاب سن یار تا ۳ روز کار می‌کند. هنگام کاهش شارژ، هم به عزیزتان و هم به شما یادآوری می‌شود تا جا نماند.",
  },
  {
    q: "آیا به سیم‌کارت نیاز دارد؟",
    a: "بله. ردیاب سن یار دارای سیم‌کارت داخلی است که ارتباط مستقل با شبکه موبایل را فراهم می‌کند؛ به این ترتیب برای کار کردن، نیازی به گوشی هوشمند یا وای‌فای ندارد.",
  },
  {
  ...
  },
  {
    ...
    a: "سن یار دقیقاً برای این شرایط طراحی شده است. ایستگاه درب هوشمند خروج بدون ردیاب را تشخیص می‌دهد و با یادآوری صوتی ملایم، فراموشی را به آرامش تبدیل می‌کند. تشخیص سرگردانی و رفتار غیرعادی نیز در کمک به این خانواده‌ها نقش دارد.",
  },
  {
