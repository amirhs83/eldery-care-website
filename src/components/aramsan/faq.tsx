...
const FAQS = [
  ...
  },
  {
    ...
    a: "هزینه اشتراک ماهانه پایین و شفاف است و شامل سیم‌کارت، پایش ۲۴ ساعته و همه به‌روزرسانی‌های هوش مصنوعی می‌شود. اعضای اولیه لیست انتظار برای همیشه ۵۰٪ تخفیف دریافت می‌کنند.",
  },
  {
