...
const QUOTES = [
  ...
  {
    text: "شب‌ها دیگه نگرانی تموم شد. مامانم هرجا باشه نقشه نشونم می‌ده، خودمم باورم نمی‌شه چقدر آروم‌تر شدم.",
    name: "سارا کریمی",
    city: "خرم‌آباد",
  },
  {
    text: "یه شب پدرم تو پارک زمین خورد. قبل از اینکه خودش بتونه زنگ بزنه، گوشیم پیام داد. واقعاً نمی‌دونم بدون این چیکار می‌کردم.",
    name: "رضا محمدی",
    city: "شیراز",
  },
  {
  ...
  {
    text: "به بچه‌ها یاد دادم دکمه‌ی وسط رو بزنن اگه مشکلی شد. حالا حس می‌کنم حتی وقتی تو مدرسه‌ان هم می‌تونم خیالم راحت باشه.",
    name: "فاطمه حسینی",
    city: "تبریز",
  },
];
